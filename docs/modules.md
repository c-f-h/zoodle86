...
- `kernel/gfx/console_palette.zig`: shared ANSI-ordered 16-colour console palette plus framebuffer-packing helper used by both text rendering and window chrome.
